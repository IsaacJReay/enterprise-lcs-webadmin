...
pub async fn put_rename_domain_name(req: HttpRequest, new_domain_name: web::Json<String>) -> Result<HttpResponse> {
    ...
    match config::named::rename_domain_name(&password, &old_domain_name, &new_domain_name.into_inner(), zone_is_internal) {
