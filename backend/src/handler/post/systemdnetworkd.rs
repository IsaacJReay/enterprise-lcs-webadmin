...
pub async fn post_wireless_network_settings(req: HttpRequest, wlanparam: web::Json<WirelessNetworkParam>) -> Result<HttpResponse> {
...
pub async fn post_static_wired_network(req: HttpRequest, s_wnetparam: web::Json<StaticWiredNetworkParam>) -> Result<HttpResponse> {
