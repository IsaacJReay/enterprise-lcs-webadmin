...
use crate::{db, linux, structs::{ForeignKey, HostapdParam, HttpResponseCustom, NTPStatus, StaticWiredNetworkParam, StatusPageResult, TimeDate, TimeDateZone, TimeDateZoneNTP, Timezone, WanPageResult, WirelessNetworkParam}, tool};

#[get("/private/api/user/query")]
pub async fn get_logindata() -> Result<HttpResponse> {
...
pub async fn get_statuspage() -> Result<HttpResponse> {
...
pub async fn get_wifipage() -> Result<HttpResponse> {
    let (_username, _password, olddate) = db::query_logindata();
...
pub async fn get_wanpage() -> Result<HttpResponse> {
    let (_username, _password, olddate) = db::query_logindata();
...
pub async fn get_wlanpage() -> Result<HttpResponse>{
    let (_username, _password, olddate) = db::query_logindata();
...
pub async fn get_domain_name_page() -> Result<HttpResponse> {
    let (_username, _password, olddate) = db::query_logindata();
...
pub async fn get_zone_record_page(foreign_key: web::Json<ForeignKey>) -> Result<HttpResponse> {
    let (_username, _password, olddate) = db::query_logindata();
    let passwordstatus: bool = tool::comparedate(olddate);
    if passwordstatus {
...
pub async fn get_timedatepage() -> Result<HttpResponse> {
    let (_username, _password, olddate) = db::query_logindata();
    let passwordstatus: bool = tool::comparedate(olddate);
    if passwordstatus {
